    ...
    <div class="xe-comment-entry">
        <div class="xe-user-img">
            <?php if (io_get_option('lazyload')): ?>
                <img class="img-circle lazy" src="<?php echo $default_ico; ?>"
                    ...
                    onerror="javascript:this.src='<?php echo $default_ico; ?>'" width="60">
            <?php else: ?>
        ...
        <div class="xe-comment">
            ...
            <p class="overflowClip_1">
                <?php echo get_post_meta($post->ID, '_sites_sescribe', true) ?: preg_replace("/(\s|\&nbsp\;|　|\xc2\xa0)/", "", get_the_excerpt($post->ID)); ?>
            </p>
        </div>

        <div class="url-card">
            <p class="url-goto mr-1">1234</p>
        </div>
    </div>
</a>